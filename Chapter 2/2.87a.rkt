...
(define (install-polynomial-package)
  ...
  (put 'project '(polynomial)  ; bring down to complex number. using shitty way, highest 
       (lambda (p) (make-complex-from-real-imag (coeff (first-term (term-list p))) 0)))              
...
(display "dropping a complex\n")
(define z5 (make-complex-from-real-imag 4 0))
(pl (drop z5))
(newline)

(display "reducing a complex to a scheme-number\n")
(define z9 (make-complex-from-real-imag 5 1))
(define z10 (make-complex-from-real-imag 5 -1))
(pl (add z9 z10))
(newline)

(display "dropping a polynomial\n")
(define L1a (make-polynomial 'x '((0 2))))
(pl L1a)
(pl (drop L1a))
(pl (project L1a))
(pl (raise (project L1a)))
(equ? L1a (raise (project L1a)))
(newline)
...
(define L10 (make-complex-from-mag-ang 4 3))
(pl (add L9 L10))
(pl (mul L9 L10))
(newline)
