...
(raise-lower-to-higher (make-complex-from-real-imag 3 4) (make-scheme-number 4))
(raise-lower-to-higher (make-scheme-number 4) (make-rational 5 6))

(add (make-complex-from-real-imag 3 4) (make-scheme-number 4))
(add (make-scheme-number 4) (make-rational 5 6))
